 ...
 * @author    Vera Sun <verasun@live.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2019 Vera Sun
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        http:github.com/verasunyy
 * Description:       A nifty business hours widget
 * Version:           1.0.0
 * Author:            Vera Sun
 * Author URI:        http:github.com/verasunyy
 * License:           GPL-2.0+
...
class Tent_Biz_Hours extends WP_Widget {
	...
	public function update( $new_instance, $old_instance ) {
		...
		//strip_tags: just stripping out the html tages from user input
		return $instance;
